...
// Any problem you faced while coding this : Currently storing the min default as Integer.MAX_VALUE, so that while iterating can hit the min value and assign it.
// Is that the correct way, to find the min value ?
